...
//
//            /**
//             * Create table 'directory_country_region_io_backup'
//             * Modify Names -
//             */
//            $table = $installer->getConnection()->newTable(
//                $installer->getTable('directory_country_region_io_backup')
//            )->addColumn(
//                'region_id',
//                \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
//                null,
...
//                'Region Name'
//            )->addIndex(
//                $installer->getIdxName('directory_country_region_io_backup', ['country_id']),
//                ['country_id']
//            )->setComment(
...
//
//            /**
//             * Create table 'directory_country_region_name_io_backup'
//             */
//            $table = $installer->getConnection()->newTable(
//                $installer->getTable('directory_country_region_name_io_backup')
//            )->addColumn(
//                'locale',
//                \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
//                8,
...
//                'Region Name'
//            )->addIndex(
//                $installer->getIdxName('directory_country_region_name_io_backup', ['region_id']),
//                ['region_id']
//            )->addForeignKey(
//                $installer->getFkName(
//                    'directory_country_region_name_io_backup',
//                    'region_id',
//                    'directory_country_region_io_backup',
//                    'region_id'
//                ),
//                'region_id',
//                $installer->getTable('directory_country_region_io_backup'),
