...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context) {
         ...
         *
         * Need to rewrite for custom state tables
         *
         */
        $data = [
            ['US', 'AL', 'Alabama'],
        ...
        foreach ($data as $row) {
            ...
            $setup->getConnection()->insert($setup->getTable('directory_country_region_io'), $bind);
            $regionId = $setup->getConnection()->lastInsertId($setup->getTable('directory_country_region_io'));

            $bind = ['locale' => 'en_US', 'region_id' => $regionId, 'name' => $row[2]];
            $setup->getConnection()->insert($setup->getTable('directory_country_region_name_io'), $bind);

//            $bind = ['country_id' => $row[0], 'code' => $row[1], 'default_name' => $row[2]];
//            $setup->getConnection()->insert($setup->getTable('directory_country_region_io_backup'), $bind);
//            $regionId = $setup->getConnection()->lastInsertId($setup->getTable('directory_country_region_io_backup'));
//
//            $bind = ['locale' => 'en_US', 'region_id' => $regionId, 'name' => $row[2]];
//            $setup->getConnection()->insert($setup->getTable('directory_country_region_name_io_backup'), $bind);
        }
